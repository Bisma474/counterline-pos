...
export function SettingsOverview() {
  ...
  const submitInvite = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      event.currentTarget.reset(); setMessage('Invitation saved. The team member can accept it after signing in.')
